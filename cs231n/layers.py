...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == 'train':
        ...
        cache = (x, batch_mean, batch_var, normalized_x, gamma, beta, eps)
        #############################################################################
        #                             END OF YOUR CODE                              #
        #############################################################################
    elif mode == 'test':
        ...
        # the out variable.                                                         #
        #############################################################################
        x_tmp = (x - running_mean) / np.sqrt(running_var + eps)
...
def batchnorm_backward(dout, cache):
    ...
    #############################################################################
    x, batch_mean, batch_var, normalized_x, gamma, beta, eps = cache
    N = x.shape[0]
    dx_normlized = dout * gamma
    dbatch_var = dx_normlized * (x - batch_mean) / -2 / ((batch_var + eps) ** (3.0 / 2))
